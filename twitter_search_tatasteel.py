...
def load_api():
    ...
    consumer_key = 'wnHfIjUS6IMuiZ88fjIpsJh2O'
    consumer_secret = 'hsrCbmuul6rGB8GZPDufLpm8x5EPjWcyXp8EPp9MjwHXnwCcI5'
    access_token = '809416734625112064-TZ29uA9CyMADk34wB4oMBCZDY758SIu'
    access_secret = 'olFQwIcaTixWcfX2AKFYifGOCTsTj5XpXc8MjlvETMRr5'
...
def main():
    ...
    USA = ''       # this geocode includes nearly all American
